...
impl<M: ExecutorMode> ScannerPlugin for WhatWebScanner<M> {
    ...
    fn metadata(&self) -> crate::plugins::PluginMetadata {
        crate::plugins::PluginMetadata {
            ...
            description: "Technology stack fingerprinter using WhatWeb with mandatory proxying."
                .to_string(),
    ...
    async fn scan(&self, target: &TargetHost) -> Result<Vec<Finding>> {
        ...
        info!(
            "🔱 V14.1 SOVEREIGN: Launching WhatWeb scan against {} via StealthExecutor...",
            target.host
        );
        ...
        let temp_file =
            tempfile::NamedTempFile::new().context("Failed to create temp file for WhatWeb")?;
        ...
        let content = tokio::fs::read_to_string(&temp_path)
            .await
            .context("Failed to read WhatWeb output")?;
